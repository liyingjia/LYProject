...
//  ForInCrachDemo
//
//  Created by 李营 on 2018/9/18.
//  Copyright © 2018年 liying. All rights reserved.
//

#import "NSAttributedString_Extension.h"

@implementation NSAttributedString_Extension
...
+(NSMutableAttributedString *)changeTextColorWithColor:(UIColor *)color string:(NSString *)str andSubString:(NSArray *)subStringArr{
    ...
    for (NSString *subString in subStringArr) {
        ...
        NSMutableArray *array = [self getRangeWithTotalString:str SubString:subString];
        //
