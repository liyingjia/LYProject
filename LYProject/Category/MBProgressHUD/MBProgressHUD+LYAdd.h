 ...
 *  LYHUDContentCustomStyle = 2,
 *
 * eg：设置为1时，调用任何这个扩展内的方法，显示出hud的UI效果都会为黑底白字风格
 */
#define LYDefaultHudStyle  1


/**
 * 风格为自定义时，在这里设置颜色
 */
#define LYCustomHudStyleBackgrandColor  [UIColor colorWithWhite:0.f alpha:0.7f]
#define LYCustomHudStyleContentColor    [UIColor colorWithWhite:1.f alpha:0.7f]
