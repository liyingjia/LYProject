...
#import "LYCustomNavigationBar.h"
...
@implementation UIViewController (LYRoute)

- (void)ly_toLastViewController
{
...
+ (UIViewController*)ly_currentViewController {
    ...
    return [self ly_currentViewControllerFrom:rootViewController];
}

+ (UIViewController*)ly_currentViewControllerFrom:(UIViewController*)viewController
{
    if ([viewController isKindOfClass:[UINavigationController class]]) {
        UINavigationController* navigationController = (UINavigationController *)viewController;
        return [self ly_currentViewControllerFrom:navigationController.viewControllers.lastObject];
    }
    else if([viewController isKindOfClass:[UITabBarController class]]) {
        UITabBarController* tabBarController = (UITabBarController *)viewController;
        return [self ly_currentViewControllerFrom:tabBarController.selectedViewController];
    }
    else if (viewController.presentedViewController != nil) {
        return [self ly_currentViewControllerFrom:viewController.presentedViewController];
    }
    else {
...
@interface LYCustomNavigationBar ()
...
@implementation LYCustomNavigationBar

+ (instancetype)CustomNavigationBar {
    LYCustomNavigationBar *navigationBar = [[self alloc] initWithFrame:CGRectMake(0, 0, kWRScreenWidth, [LYCustomNavigationBar navBarBottom])];
...
-(void)updateFrame {
//    NSInteger top = ([LYCustomNavigationBar isIphoneX]) ? 44 : 20;
    NSInteger top = StatusBarHeight;
    NSInteger margin = 0;
...
-(void)clickBack {
    if (self.onClickLeftButton) {
        ...
        UIViewController *currentVC = [UIViewController ly_currentViewController];
        [currentVC ly_toLastViewController];
    }
}
-(void)clickRight {
...
#pragma mark - 左右按钮
- (void)ly_setLeftButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor {
...
- (void)ly_setLeftButtonWithImage:(UIImage *)image title:(NSString *)title titleColor:(UIColor *)titleColor {
    [self ly_setLeftButtonWithNormal:image highlighted:image title:title titleColor:titleColor];
}
- (void)ly_setLeftButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted {
    [self ly_setLeftButtonWithNormal:normal highlighted:highlighted title:nil titleColor:nil];
}
- (void)ly_setLeftButtonWithImage:(UIImage *)image {
    [self ly_setLeftButtonWithNormal:image highlighted:image title:nil titleColor:nil];
}
- (void)ly_setLeftButtonWithTitle:(NSString *)title titleColor:(UIColor *)titleColor {
    [self ly_setLeftButtonWithNormal:nil highlighted:nil title:title titleColor:titleColor];
}

- (void)ly_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor {
...
- (void)ly_setRightButtonWithImage:(UIImage *)image title:(NSString *)title titleColor:(UIColor *)titleColor {
    [self ly_setRightButtonWithNormal:image highlighted:image title:title titleColor:titleColor];
}
- (void)ly_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted {
    [self ly_setRightButtonWithNormal:normal highlighted:highlighted title:nil titleColor:nil];
}
- (void)ly_setRightButtonWithImage:(UIImage *)image {
    [self ly_setRightButtonWithNormal:image highlighted:image title:nil titleColor:nil];
}
- (void)ly_setRightButtonWithTitle:(NSString *)title titleColor:(UIColor *)titleColor {
    [self ly_setRightButtonWithNormal:nil highlighted:nil title:title titleColor:titleColor];
}
