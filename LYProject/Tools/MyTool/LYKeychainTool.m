...
NSString * const KEY_UDID_INSTEAD = @"com.happyaft.mchtseller";

@implementation LYKeychainTool

+(NSString *)getDeviceIDInKeychain {
    NSString *getUDIDInKeychain = (NSString *)[LYKeychainTool load:KEY_UDID_INSTEAD];
    ...
    if (!getUDIDInKeychain ||[getUDIDInKeychain isEqualToString:@""]||[getUDIDInKeychain isKindOfClass:[NSNull class]]) {
        ...
        [LYKeychainTool save:KEY_UDID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[LYKeychainTool load:KEY_UDID_INSTEAD];
    }
