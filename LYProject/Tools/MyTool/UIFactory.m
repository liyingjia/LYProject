...
+ (UIButton *)buttonWithFrame:(CGRect)frame title:(NSString *)title font:(UIFont *)font titleColorNormal:(UIColor *)titleColorNormal imageNormal:(UIImage *)imageNormal imageHighlighted:(UIImage *)imageHighlighted target:(id)target touchAction:(SEL)action
{
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    button.frame = frame;
    [button setTitle:title forState:UIControlStateNormal];
    ...
    [button setImage:imageHighlighted forState:UIControlStateDisabled];
    if(target){
        [button addTarget:target action:action forControlEvents:UIControlEventTouchUpInside];
    }
    return button;
...
+ (UIButton *)buttonWithFrame:(CGRect)frame title:(NSString *)title font:(UIFont *)font titleColorNormal:(UIColor *)titleColorNormal titleColorSelected:(UIColor *)titleColorSelected target:(id)target touchAction:(SEL)action{
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    button.frame = frame;
    [button setTitle:title forState:UIControlStateNormal];
    [button setTitleColor:titleColorNormal forState:UIControlStateNormal];
...
+ (UIButton *)buttonWithFrame:(CGRect)frame type:(UIButtonType)type title:(NSString *)title font:(UIFont *)font titleColorNormal:(UIColor *)titleColorNormal titleColorSelected:(UIColor *)titleColorSelected target:(id)target touchAction:(SEL)action{
